...
export const varianceAnalysis = [
  { area: "Почему не выполнен план продаж", metric: "План / факт по выручке", deviation: "-3 650 000 ₽ (-13%)", cause: "Слабый pipeline у Сергея Минина, потеря 2 сделок в сегменте SMB", action: "Усилить контроль pipeline, разбор причин потерь" },
  { area: "Почему не выполнен план оплат", metric: "План / факт оплат", deviation: "-4 800 000 ₽ (-22%)", cause: "Просрочка у клиентов «Альфа Логистика» и «ТрейдГранд»", action: "Ограничить отгрузку с отсрочкой клиентам с просрочкой" },
  { area: "Почему просела маржа", metric: "Средняя маржинальность", deviation: "-3,2 п.п. к плану", cause: "Скидки 4-6% на крупных сделках Ивана Иванова", action: "Пересмотреть минимальную маржу и регламент скидок" },
  { area: "Почему выросла дебиторка", metric: "Дебиторская задолженность", deviation: "+1 240 000 ₽ за месяц", cause: "Отгрузки рискованным клиентам без согласования", action: "Согласование сделок с отсрочкой для клиентов в статусе «риск»" },
  { area: "Где зависли сделки", metric: "Сделки на этапе КП > 7 дней", deviation: "8 сделок", cause: "Отсутствует follow-up по 5 сделкам", action: "Назначить следующий шаг по каждой сделке" },
  { area: "Какие клиенты создают риск", metric: "Доля просрочки в выручке клиента", deviation: ">30% у 3 клиентов", cause: "«Альфа Логистика», «ТрейдГранд», «Лига Ритейл»", action: "Перевести клиентов в статус «риск» / «стоп»" },
  { area: "Какие менеджеры требуют внимания", metric: "Индекс качества продаж", deviation: "48 / 100 — Иван Иванов", cause: "Большая выручка, но низкая маржа и высокая просрочка", action: "KPI по оплаченной выручке и марже, разбор сделок" },
];
